                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="iq-fancy-box-list iq-fancy-box-list-1  text-left iq-shadow">
                        <div class="iq-fancy-box-content">
                            ...
                            <div class="iq-fancy-details">
                                <h4 class="iq-fancy-title"> Disk customisation</h4>
                                <div class="special-content">
                        ...
                        <div class="iq-fancy-box-content">
                            ...
                            <div class="iq-fancy-details">
                                ...
                                <div class="special-content">
                                    ...
                                    <br>
                                    <a href="/bare-metal/os">Find Out more</a>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="iq-fancy-box-list iq-fancy-box-list-1  text-left iq-shadow">
                        <div class="iq-fancy-box-content">
                            ...
                            <div class="iq-fancy-details">
                                <h4 class="iq-fancy-title">Service Level Agreement — 99.90%
                                </h4>
                                <div class="special-content">
