                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-12">
                            <nav aria-label="breadcrumb" class="text-center iq-breadcrumb-two">
                                <h2 class="title">
                           Optional With Advance Server                      </h2>
                                <ol class="breadcrumb main-bg">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)"><i class="fa fa-home mr-2"></i>Bare Metal Advance</a></li>
                                    <li class="breadcrumb-item active"> Options With Advance Server </li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="iq-fancy-box-list iq-fancy-box-list-1  text-left iq-shadow">
                        <div class="iq-fancy-box-content">
                            ...
                            <div class="iq-fancy-details">
                                ...
                                <div class="special-content">
                                    <p class="fancy-box-content">Our dedicated servers have a default public bandwidth. Depending on your project’s resource requirements, you can choose an additional guaranteed bandwidth option. This ensures you maintain constant throughput for ingress and egress traffic.
