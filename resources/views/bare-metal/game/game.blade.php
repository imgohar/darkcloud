                ...
                <div class="col-lg-6 col-sm-12 ">
                    <div class="iq-title-box iq-title-default iq-title-box-2">
                        ...
                        <p> 
                            ...
                            <a class="btn btn-primary" href="">View Prices</a>
                            <br> <br>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="text-right">
                    <a href="" class="btn btn-outline-primary">All Services Included</a>
                </div>
                    ...
                    <div class="iq-fancy-box-list iq-fancy-box-list-1  text-left iq-shadow">
                        <div class="iq-fancy-box-content">
                            ...
                            <div class="iq-fancy-details">
                                ...
                                <div class="special-content">
                                    <p class="fancy-box-content"> Offer your users the very best gaming experience, and efficient protection against DDoS attacks. Achieve economies of scale by hosting your gaming servers at the best price. Get peace of mind with OVHcloud.
                                    </p>
                                </div>
                    ...
                    <div class="iq-fancy-box-list iq-fancy-box-list-1  text-left iq-shadow">
                        <div class="iq-fancy-box-content">
                            ...
                            <div class="iq-fancy-details">
                                ...
                                <div class="special-content">
                                    <p class="fancy-box-content"> Delegate hosting to a specialist, and focus on your work. Whether you are looking to host gaming server clusters, cloud gaming, or anything else, OVHcloud solutions can be adapted to suit your needs.
                                    </p>
                                </div>
            ...
            <div class="row">
                <div class="iq-masonry-block w-100 ">
                    <div class="isotope-filters isotope-tooltip">
                        ...
                        <a href="" class="btn btn-outline-primary">Explore your options</a>
                    </div>
                ...
                <div class="iq-accordion  iq-accordion-semi-round iq-accordion-classic">
                    ...
                    <div class="iq-accordion-block   2">
                        ...
                        <div class="iq-accordion-details">
                            ...
                            <p class="iq-content-text"> The options are available at the server configuration step. You can also order and enable options directly via the OVHcloud Control Panel, after your service has been delivered.</p>
